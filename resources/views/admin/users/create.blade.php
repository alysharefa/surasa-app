<x-layouts.admin 
    ...
    :breadcrumbs="[['label' => 'Users', 'url' => route('admin.users.index')], ['label' => 'Tambah Baru']]"
>
    <!-- Actions -->
    ...
    <div class="max-w-2xl">
        <div class="bg-surface-light dark:bg-surface-dark rounded-lg p-6 md:p-10 shadow-sm border border-neutral-100 dark:border-neutral-800">
            <form id="user-form" action="{{ route('admin.users.store') }}" method="POST" class="flex flex-col gap-6">
                @csrf
                ...
                <label class="flex flex-col gap-2">
                    <span class="text-sm font-semibold text-neutral-700 dark:text-neutral-300">Password *</span>
                ...
                <label class="flex flex-col gap-2">
                    <span class="text-sm font-semibold text-neutral-700 dark:text-neutral-300">Konfirmasi Password *</span>
